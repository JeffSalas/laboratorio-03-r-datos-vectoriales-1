...
```{r}
ggplot(centro_america, aes(x=centro_america$name_long, y=centro_america$lifeExp)) +
  ggtitle('Esperanza de vida en Centroamérica') +
  xlab('Países') +
...
```{r}
paises_lifeExp74 = world[world$name_long == "Nicaragua" | world$name_long == "Costa Rica" | world$name_long == "Panama" ,]

plot(paises_lifeExp74 ["lifeExp"], main = "Esperanza de vida mayor a 74 años en Centroamérica")
